...
# everything in environment are objects of some type
# Objects: in your environment, has a type, has a class, elements in objects
...
# turning classes into different classes
...
names(dat) # a column name, types of data being recorded
dim(dat) # dimensions
head(dat) # by default gives us first 6 data sets
...
str(dat) # structure of a data frame
